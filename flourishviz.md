...
When we select only the countries that are members of the G7, the debt level of most of them is above the OECD average of 95%, with only Germany below it.
